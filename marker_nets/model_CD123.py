...
if __name__ == "__main__":
    ...
    markers = ('CD45', 'CD3', 'CD56', 'gdTCR', 'CD196_CCR6',
               ...
               'CD28', 'CD197_CCR7', 'CD11c ', 'CD33', 'CD152_CTLA-4', 'CD161',
               'CD185_CXCR5', 'CD183_CXCR3', 'CD94', 'CD57', 'CD45RO',
               'CD127_IL-7Ra', 'CD279_PD-1', 'CD38', 'CD194_CCR4', 'CD20', 'CD16',
               'HLA-DR', 'CD4', 'CD8a', 'CD11b')
    ...
    ## save model
    model.save('C:/Users/pc/OneDrive/git_repo/Auto_IMMsight/Models/CD123_classfy.h5')
